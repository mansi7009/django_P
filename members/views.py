...
def edit_device(request,pk,model,cls):
    ...
    if request.method == 'POST':
        ...
        #ek bhi item nai h or hme add krna h to ek new form create hoga usme add krenge values and vo fir database mei append hoga
...
def delete_devices(request,pk,model):
...
def delete_laptop(request,pk):
    return delete_devices(request,pk,Laptop)

def delete_desktop(request,pk):
    return delete_devices(request,pk,Desktop)
    
def delete_mobile(request,pk):
    return delete_devices(request,pk,Mobile)
